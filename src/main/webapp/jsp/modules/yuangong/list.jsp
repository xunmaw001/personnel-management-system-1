...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="bumen" id="bumenSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										性别
									</label>
	...
	<script>
		...
		function search(){
			...
			var bumenIndex = document.getElementById("bumenSelect").selectedIndex;
			var bumenOptions = document.getElementById("bumenSelect").options;
			var bumenSelectedOption = bumenOptions[bumenIndex]
			if(bumenSelectedOption.text != null && bumenSelectedOption.text != ''){
				searchForm.bumen = "%" + bumenSelectedOption.text + "%";
			}

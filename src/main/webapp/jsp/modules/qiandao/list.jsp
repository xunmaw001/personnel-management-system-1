...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>签到管理</span></li>
								<li class="breadcrumb-item active"><span>签到列表</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function sh(){
			...
			httpJson("qiandao/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qiandao");

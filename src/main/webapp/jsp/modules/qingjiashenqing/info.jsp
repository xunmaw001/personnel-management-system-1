							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group  col-md-12">
										<label>请假理由</label>
										<script id="qingjialiyouEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.qingjialiyou != null && ruleForm.qingjialiyou != 'null' && ruleForm.qingjialiyou != ''){
				var mes = '' + ruleForm.qingjialiyou;
				var qingjialiyouUeditor = UE.getEditor('qingjialiyouEditor');
				qingjialiyouUeditor.ready(function() {
					qingjialiyouUeditor.setContent(mes);
					qingjialiyouUeditor.setDisabled('fullscreen');
				});
			}

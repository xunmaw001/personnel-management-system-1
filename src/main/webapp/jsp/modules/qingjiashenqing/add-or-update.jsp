		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑请假申请</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑请假申请</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">请假申请信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>请假理由</label>
										<textarea name="qingjialiyou" class="form-control" id="qingjialiyou" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>请假时间</label>
										<div id="qingjiashijianDate" class="input-append date form_datetime">
											<input id="qingjiashijian-input" name="qingjiashijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qingjiashenqing/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("qingjiashenqing/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){

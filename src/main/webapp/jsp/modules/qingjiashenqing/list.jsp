...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">请假申请管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>请假申请管理</span></li>
								<li class="breadcrumb-item active"><span>请假申请列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">请假申请列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var qingjialiyouCell  = document.createElement('td');

						  if(item.qingjialiyou != null && item.qingjialiyou != "" && item.qingjialiyou.length >= 11){
			  	qingjialiyouCell.innerHTML = item.qingjialiyou.substring(0, 10) + "..."; 
			  }else{
			  	qingjialiyouCell.innerHTML = item.qingjialiyou;
			  }


			row.appendChild(qingjialiyouCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("qingjiashenqing/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("qingjiashenqing/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qingjiashenqing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("qingjiashenqing"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qingjiashenqing");

						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jingligonghao" name="jingligonghao" class="form-control" v-model="ruleForm.jingligonghao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>密码</label>
									...
									<input id="jinglixingming" name="jinglixingming" class="form-control" v-model="ruleForm.jinglixingming" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>性别</label>

						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jixiaogongzi" name="jixiaogongzi" class="form-control" v-model="ruleForm.jixiaogongzi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>加班工资</label>
									...
									<input id="quanqin" name="quanqin" class="form-control" v-model="ruleForm.quanqin" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>迟到早退</label>

									<input id="chidaozaotui" name="chidaozaotui" class="form-control" v-model="ruleForm.chidaozaotui" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>请假</label>

									<input id="qingjia" name="qingjia" class="form-control" v-model="ruleForm.qingjia" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>个税</label>

									<input id="geshui" name="geshui" class="form-control" v-model="ruleForm.geshui" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>社保代缴</label>

									<input id="shebaodaijiao" name="shebaodaijiao" class="form-control" v-model="ruleForm.shebaodaijiao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>实发工资</label>
